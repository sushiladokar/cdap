...
/**
 * This class represents messages to be published. The message payloads are provide through the {@link Iterator}.
 */
public abstract class PublishRequest extends AbstractIterator<byte[]> {
  ...
  protected PublishRequest(TopicId topicId, boolean transactional, long transactionWritePointer) {
   ...
   * method returns {@code null} on the first time being called, it means this {@link PublishRequest} represents
