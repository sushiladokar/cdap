...
public final class MessagingUtils {
  ...
  /**
   * Convert {@link TopicId} to byte array for message tables.
   *
  ...
  /**
   * Convert byte array back to the {@link TopicId}.
   *
   * @param topicBytes byte array which contains the representation of the topic id
   * @param offset offset where the byte array representation starts
  ...
  /**
   * Convert byte array back to {@link TopicId}.
   *
   * @param topicBytes byte array which contains the representation of the topic id
   * @return {@link TopicId}
   */
