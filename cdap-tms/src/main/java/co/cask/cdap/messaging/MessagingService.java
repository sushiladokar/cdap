...
import co.cask.cdap.messaging.service.PublishRequest;
...
public interface MessagingService {
   ...
   * @param messages the {@link PublishRequest} containing messages to be published
   * @throws TopicNotFoundException if the topic doesn't exist
   * @throws IOException if failed to publish messages
   */
  void publish(TopicId topicId, PublishRequest messages) throws TopicNotFoundException, IOException;
   ...
   * @param messages the {@link PublishRequest} containing messages to be stored
   * @throws TopicNotFoundException if the topic doesn't exist
   * @throws IOException if failed to store messages
   */
  void storePayload(TopicId topicId, PublishRequest messages) throws TopicNotFoundException, IOException;
   ...
   */
  void rollback(TopicId topicId, long transactionWritePointer) throws TopicNotFoundException, IOException;
}
