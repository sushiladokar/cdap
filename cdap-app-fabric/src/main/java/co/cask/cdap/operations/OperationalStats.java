...
/**
 * Base class for all operational stats emitted using the operational stats extension framework.
 *
 ...
 */
public abstract class OperationalStats {
  /**
   * Returns the service name for which this operational stat is emitted.
   */
